 ...
 export default function Navbar({ userEmail }) {
  ...
  const linkClasses = (path) =>
    `px-3 py-2 rounded-md text-sm font-medium transition-colors duration-150 ease-in-out ${
      pathname === path
        ? 'bg-[#9FB3DF] text-[#FFF1D5]'
        : 'text-[#FFF1D5] hover:bg-[#9FB3DF] hover:text-[#FFF1D5]'
    }`;

  return (
    <nav className="bg-[#9EC6F3] shadow-md">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <div className="flex-shrink-0">
              ...
              <span className="text-[#FFF1D5] font-bold text-xl ">ReciSearch</span>
            </div>
